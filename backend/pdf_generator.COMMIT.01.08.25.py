...
def generate_invoice_pdf(output_filepath, data):
    ...
    story.append(Spacer(1, 0.2 * inch))
        ...
        # --- Signatures Section ---
    # Define content for each signature block
    signature_line = Paragraph("_____________________________", styles['CenterAlign'])
    sig1_content = [
        signature_line,
        Spacer(1, 0.05*inch),
        Paragraph("<b>Harry Odar Mazza</b>", styles['BoldNormalCenter']),
        Paragraph("DNI 42411175", styles['SmallFontCenter']),
        Paragraph("MILENIO CONSULTORES SAC", styles['SmallFontCenter'])
    ]
    sig2_content = [
        signature_line,
        Spacer(1, 0.05*inch),
        Paragraph("<b>Juan Ricardo Gallo Pizarro</b>", styles['BoldNormalCenter']),
        Paragraph("DNI 02816271", styles['SmallFontCenter']),
        Paragraph("INANDES CAPITAL FACTOR SAC", styles['SmallFontCenter'])
    ]
    sig3_content = [
        signature_line,
        Spacer(1, 0.05*inch),
        Paragraph("<b>Harry Odar Mazza</b>", styles['BoldNormalCenter']),
        Paragraph("DNI 42411175", styles['SmallFontCenter']),
        Paragraph("GARANTE / FIADOR SOLIDARIO", styles['SmallFontCenter'])
    ]
    sig4_content = [
        signature_line,
        Spacer(1, 0.05*inch),
        Paragraph("<b>Harry Odar Mazza</b>", styles['BoldNormalCenter']),
        Paragraph("DNI 42411175", styles['SmallFontCenter']),
        Paragraph("DEPOSITARIO", styles['SmallFontCenter'])
    ]
    sig5_content = [
        signature_line,
        Spacer(1, 0.05*inch),
        Paragraph("<b>Guillermo Francisco Odar Cabrejos</b>", styles['BoldNormalCenter']),
        Paragraph("DNI 07723067", styles['SmallFontCenter']),
        Paragraph("GARANTE / FIADOR SOLIDARIO", styles['SmallFontCenter'])
    ]
    ...
    signatures_data = [
        [sig1_content, "", sig2_content],
        [sig3_content, sig4_content, sig5_content]
    ]
...
if __name__ == '__main__':
    ...
    sample_data = {
        ...
        'intereses_adicionales_int': '',
        'intereses_adicionales_igv': '',
        'intereses_adicionales_total': '',
    }
    output_dir = "C:/Users/rguti/Inandes.TECH/generated_pdfs"
    os.makedirs(output_dir, exist_ok=True)
    output_file = os.path.join(output_dir, "generated_invoice.pdf")
    generate_invoice_pdf(output_file, sample_data)
